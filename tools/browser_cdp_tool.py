...
async def _cdp_call(ws_url: str, method: str, params: Dict[str, Any], target_id: Optional[str],
    ...
    connection = websockets.connect(ws_url, max_size=None, open_timeout=timeout, close_timeout=5,
                                    ping_interval=None, **loopback_connect_kwargs(ws_url))
    if inspect.isawaitable(connection) and not hasattr(connection, "__aenter__"):
