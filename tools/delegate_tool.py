...
def _build_child_agent(
    ...
    child = AIAgent(
        ...
        session_search_source_filter=getattr(parent_agent, "_session_search_source_filter", None),
        session_search_user_id_filter=getattr(parent_agent, "_session_search_user_id_filter", None),
        session_search_include_unowned_user_sessions=getattr(parent_agent, "_session_search_include_unowned_user_sessions", False),
