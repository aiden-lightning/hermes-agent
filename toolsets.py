...
_HERMES_CORE_TOOLS = [
    ...
    "browser_connect", "browser_navigate", "browser_snapshot", "browser_click",
...
_FEISHU_TOOLS = ["curl", "feishu_doc_read", "feishu_bitable_read", *_FEISHU_DRIVE_TOOLS]
...
TOOLSETS = {
    ...
    "curl": _ts("Safe HTTP/HTTPS requests with no local file access", ["curl"]),
    "cronjob": _ts(
    ...
    "feishu_bitable": _ts("Read Feishu/Lark bitable records", ["feishu_bitable_read"]),
    "feishu_drive": _ts("Feishu/Lark document comment operations (list, reply, add)", _FEISHU_DRIVE_TOOLS),
    "spotify": _ts(
