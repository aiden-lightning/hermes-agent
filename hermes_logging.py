...
def setup_logging(
    *,
    ...
    handler_specs = (
        ...
        # gateway.log follows the configured level, not a hard-coded INFO floor: DEBUG-only
        # gateway diagnostics (e.g. Feishu mention-gate drops) must be persisted when
        # logging.level=DEBUG, which is the whole point of turning DEBUG on.
        ("gateway.log", level, 5 * 1024 * 1024, 3, "gateway"),
