...
from agent.process_bootstrap import (
    ...
    _SafeWriter as _BootstrapSafeWriter,
    _install_safe_stdio as _bootstrap_install_safe_stdio,
...
_SafeWriter = _BootstrapSafeWriter  # re-exported for compatibility/tests
_install_safe_stdio = _bootstrap_install_safe_stdio
...
class AIAgent:
    ...
    def __init__(
        ...
        init_agent(
            ...
            session_search_source_filter=session_search_source_filter,
            session_search_user_id_filter=session_search_user_id_filter,
            session_search_include_unowned_user_sessions=session_search_include_unowned_user_sessions,
    ...
    def _invoke_tool(self, function_name: str, function_args: dict, effective_task_id: str,
        ...
        if not pre_tool_block_checked:
            try:
                ...
                block_message = get_pre_tool_call_block_message(
                    ...
                    api_request_id=getattr(self, "_current_api_request_id", ""),
                )
            except Exception:
                pass
        ...
        if function_name == "todo":
            ...
            return _finish_agent_tool(self._memory_manager.handle_tool_call(function_name, function_args))
            ...
            return _finish_agent_tool(self._dispatch_delegate_task(function_args))
        else:
            try:
                ...
                _cancelled_result = json.dumps({"status": "cancelled", "error": "keyboard_interrupt"})
                _emit_post_tool_call_hook(
                    function_name=function_name,
                    function_args=function_args,
