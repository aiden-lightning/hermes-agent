...
DEFAULT_CONFIG = {
    ...
    # Gemini 32000, Edge 5000, Mistral 4000, NeuTTS/KittenTTS/MOSS 2000).
    "tts": {
        "provider": "edge",  # "edge" (free) | "elevenlabs" (premium) | "openai" | "xai" | "minimax" | "mistral" | "gemini" | "neutts" (local) | "kittentts" (local) | "moss" (local) | "piper" (local)
        "edge": {
        ...
        "moss": {
            "model_dir": "",      # Empty = runtime default inside bundled repo
