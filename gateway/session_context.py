...
# * ENABLED_TOOLSETS: comma-separated toolsets the bound session may use, so a cron job created
#   from a restricted session cannot widen its own toolset (read in tools/cronjob_tools.py).
...
_SESSION_VARS = (
    ...
    _SESSION_USER_NAME, _SESSION_SCOPE_ID, _SESSION_KEY, _SESSION_ENABLED_TOOLSETS, _SESSION_ID,
    ...
    "HERMES_SESSION_SCOPE_ID", "HERMES_SESSION_KEY", "HERMES_SESSION_ENABLED_TOOLSETS",
    "HERMES_SESSION_ID",
...
def set_session_vars(
    ...
    user_name: str = "", scope_id: str = "", session_key: str = "",
    enabled_toolsets: str = "", session_id: str = "",
    ...
    values = (
        ...
        user_name, scope_id, session_key, enabled_toolsets, session_id, ui_session_id,
        message_id, profile,
