...
class TurnRunner:
    ...
    def _build_fresh_agent(self, turn_route, platform_key, combined_ephemeral, max_iterations,
        ...
        return ctx.AIAgent(
            ...
            session_owner_user_id=runner._resolve_session_owner_user_id(src),
            session_search_source_filter=(ctx.session_search_filters or {}).get("source_filter"),
            session_search_user_id_filter=(ctx.session_search_filters or {}).get("user_id_filter"),
            session_search_include_unowned_user_sessions=(ctx.session_search_filters or {}).get(
    ...
    def _resolve_turn_agent(self, turn_route, platform_key, combined_ephemeral, max_iterations, reasoning_config, pr):
        ...
        sig = runner._agent_config_signature(
            ...
            skip_context_files=skip_context_files,
            session_search_filters=ctx.session_search_filters,
        )
