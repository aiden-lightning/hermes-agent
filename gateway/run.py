...
from gateway.run_permissions import GatewayPermissionsMixin
...
class GatewayRunner(
    GatewayAuthorizationMixin, GatewayPermissionsMixin, GatewayKanbanWatchersMixin, GatewaySlashCommandsMixin,
    ...
    def _set_session_env(
        self, context: SessionContext, *, enabled_toolsets: Optional[List[str]] = None,
    ) -> list:
    ...
    class _RunAgentDisplay:
        ...
        session_search_filters: Any = None
